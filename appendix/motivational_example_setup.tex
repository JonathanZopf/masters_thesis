...
\emph{Causal Concept Faithfulness} by Matton et al.~\cite{mattonWalkTalkMeasuring2024} and FELICS both extract the concepts described as influential for decision from the natural language explanation via an auxiliary LLM. However to reduce the effort in setting up this simple experiment, the LLM to evaluate itself was asked to provide a list of the influential concepts in conjunction with the explanation, making it possible to parse it directly from the response. The alignment of both the list and the explanation where verified by human reviewers.
