...
This appendix documents the experimental setup behind the motivating examples presented in the introduction. It describes the scenario design, prompt and sampling choices, explanation extraction, modified second run, and the principal observations used in the main text.
